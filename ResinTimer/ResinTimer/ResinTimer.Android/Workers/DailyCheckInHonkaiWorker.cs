...
{
    public class DailyCheckInHonkaiWorker : Worker
    {
        private const int NotiId = 9001;

        public DailyCheckInHonkaiWorker(Context context, WorkerParameters parameters) : base(context, parameters)
        {
        ...
        public override Result DoWork()
        {
            ...
            try
            {
                Log.WriteLine(LogPriority.Info, "ResinTimer", $"Daily CheckIn Honkai Work : {DateTime.Now}");
                ...
                message = $"{message} ({AppResources.GameType_Honkai3rd})";
